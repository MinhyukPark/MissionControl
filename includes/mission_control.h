...
class MissionControl {
    public:
        ...
        int run_executables();
        int add_executable(std::string executable_name, std::string executable_path, std::string executable_output);
        ...
        struct MetaExecutable {
            ...
            MetaExecutable(char* executable_path, char* executable_output, char** executable_arguments, int executable_arguments_count):executable_path(executable_path), executable_output(executable_output), executable_arguments(executable_arguments), executable_arguments_count(executable_arguments_count) {
            };
            ~MetaExecutable(){
                clear();
            }
