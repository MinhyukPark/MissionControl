...
const std::string INPUT_FILE_NAME = USER_SCRATCH + "input/1000S1/R0/rose.aln.true.fasta"; // e.g. "true.fasta", "unaligned.fasta"
const std::string CURRENT_DATASET = "1000S1"; // e.g. "1000S1", "1000M1"
const std::string CURRENT_REPLICATE = "R0"; // e.g. "R0", "R1"
const std::string MAX_SUBSET_SIZE_STR = "50"; // e.g. "120", "500"
