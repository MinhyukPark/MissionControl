...
int MissionControl::run_executables() {
    ...
    for(int i = 0; i < this->executable_count; i ++) {
        ...
        MetaExecutable* current_meta_executable = new MetaExecutable(current_executable_path_ptr, current_executable_arguments_ptr, current_executable_arguments_count);
